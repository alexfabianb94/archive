...
<hr class="featurette-divider" />
   <h2 class="featurette-heading iccl-color">Downloads</h2>
   <div class="row">
   <div class="col-sm-12">
       ...
       <tbody>
           <tr>
               <td>Consent to Publish</td>
               <td>2019-06-07</td>
               <td>2019-06-07</td>
               <td><a href="downloads/Contract_Book_Contributor_Consent_to_Publish_LNCS_SIP.pdf">Download</a></td>
           </tr>
           <tr>
               <td>Springer Guidelines for Authors</td>
               <td>2019-06-07</td>
               <td>2019-06-07</td>
               <td><a href="downloads/Springer_Guidelines_for_Authors_of_Proceedings_CS.pdf">Download</a></td>
           </tr>
           <tr>
               <td>Inscription tutorial <label class="badge badge-danger">new</label></td>
               <td>2019-08-07</td>
               <td>2019-08-07</td>
               <td><a href="downloads/iccl2019_inscriptions.pdf">Download</a></td>
           </tr>
           <tr>
               <td>Android Mobile App <label class="badge badge-danger">new</label></td>
               <td>2019-09-30</td>
               <td>2019-09-30</td>
               <td><a href="downloads/iccl2019.apk">Download</a></td>
           </tr>                                     
       </tbody>
       </table>             
   </div>     
</div>
    <h2 class="featurette-heading">How to install the app </h2>
    <hr>
    <div class="row featurette">
       <div class="row>
            ...
            <div class="col-sm-3">
                ...
                <label class="text-center">Download the iccl2019.apk file</label>
            </div>
            <div class="col-sm-3">
                <img src="img/permission1.jpg" style="width: 100%;" />
                <label class="text-center">Once the download has finished, tap to open the file and Android will ask for permission</label>
            </div>
            <div class="col-sm-3">
                <img src="img/permission2.jpg" style="width: 100%;" />
                <label class="text-center">Allow your browser (Firefox, Chrome, Opera, etc.) to run the file and go back.</label>
            </div>
            <div class="col-sm-3">
                <img src="img/install.jpg" style="width: 100%;" />
                <label class="text-center">Tap on Install, android will take a fow seconds to install the app.</label>
            </div>
            <div class="col-sm-3">
                <img src="img/open.jpg" style="width: 100%;" />
                <label class="text-center">Tap on open, to execute the app.</label>            
            </div>
            <div class="col-sm-3">
                <img src="img/appui.jpg" style="width: 100%;" />
                <label class="text-center">Tap on any session, to see the list of talks or tap on the upper menu to check other options.</label>            
            </div>
       </div>
    </div>
