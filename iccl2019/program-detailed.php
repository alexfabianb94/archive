...
<div class="row" style="margin-top: 10px;">
    ...
    <a href="program.php" class="btn btn-primary">Back to Tab View</a>
    <hr class="featurette-divider">
    <div class="row featurette">
      <div class="col-sm-12">
      <div class="table-responsive">
        <table id="table-program" class="table table-condensed table-font">
            <thead>
                <tr>
                    <th>Date</th>
                    <th>Start</th>
                    ...
                    <th>Title</th>
                    <th class="hidden-xs">Abstract</th>
                    <th>Session</th>
                    <th>Authors</th>
                </tr>
            </thead>
