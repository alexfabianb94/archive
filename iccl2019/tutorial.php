...
<hr class="featurette-divider" />
    <div class="row featurette">
        <div class="col-sm-12">
            <h2 class="featurette-heading iccl-color">Inscription Tutorial</h2>
            <p class="text-muted">Requires Google Chrome or Mozilla Firefox.</p>
            <div class="lead text-center">
            <iframe style="width: 970px; height: 660px; border: none; margin-left: auto; margin-right: auto;" src="tutorial/index.html"></iframe>
            </div>
            <p>Download a printable version of this tutorial <a href="downloads.php">here.</a></p>
        </div>
