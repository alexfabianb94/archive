...
<div class="row" style="margin-top: 10px;">
   ...
   <h2 class="featurette-heading">
    <i class="fa fa-asterisk fa-spin iccl-color"></i>
    <a href="https://link.springer.com/book/10.1007/978-3-030-31140-7">ICCL 2019 LNCS Proceedings Download</a>
    <i class="fa fa-asterisk fa-spin iccl-color"></i>
   </h2>
   </div>
   </div>
   ...
   <div class="col-sm-12 text-center">
   <h2 class="featurette-heading">
   <a href="http://iccl2019.co/downloads.php">Download ICCL2019 Mobile App for Android</a>
   </h2>
   </div>
   </div>
   <hr class="featurette-divider">
   <div class="row featurette">
   <div class="col-sm-12">
   <h2 class="featurette-heading">Topics <span class="text-muted">- ICCL 2019</span></h2>
   <p class="text-muted">Topics to be covered include (but are not limited to):</p>
   <div class="columns">
    <ul>
   ...
   <hr class="featurette-divider">
   <h2 class="featurette-heading">Latest <span class="text-muted"> News</span></h2>
   <p class="text-muted">Find out the latest news around ICCL 2019:</p>
   <div class="row featurette">
   <div class="col-sm-12">
   <div class="card golge">
   <div class="card-body">
     <div class="carousel vert slide" data-ride="carousel" data-interval="10000">
       <div class="carousel-inner"><div class="carousel-item active"><ul class="timeline"><li><a href="#">New section added</a><a href="#" class="float-right">2019-09-04 02:18:00</a><p>New Program section added. <a href="program.php">Check out.</a></p></li><li><a href="#">Keynote Speaker Added</a><a href="#" class="float-right">2019-09-03 15:53:00</a><p>Keynote Speakers section updated. <a href="keynote-speakers.php">Check out.</a></p></li></ul></div><div class="carousel-item "><ul class="timeline"><li><a href="#">Keynote Speakers Added</a><a href="#" class="float-right">2019-08-19 13:51:00</a><p>New Keynote Speakers section added. <a href="keynote-speakers.php">Check out.</a></p></li><li><a href="#">Early registration extended</a><a href="#" class="float-right">2019-08-01 13:59:00</a><p>Early registration date extended to Aug. 9. <a href="dates.php">Check out.</a></p></li></ul></div><div class="carousel-item "><ul class="timeline"><li><a href="#">Notifications of acceptance updated</a><a href="#" class="float-right">2019-07-15 13:10:41</a><p>The Notifications of Acceptance date has been moved. <a href="dates.php">Check out.</a></p></li><li><a href="#">Deadline updated</a><a href="#" class="float-right">2019-06-13 16:00:41</a><p>The submission deadline has been updated. <a href="dates.php">Check out.</a></p></li></ul></div><div class="carousel-item "><ul class="timeline"><li><a href="#">Papers guidelines Updated</a><a href="#" class="float-right">2019-06-07 12:10:41</a><p>Papers guidelines updated. <a href="papers.php">Check out.</a></p></li><li><a href="#">Downloads section</a><a href="#" class="float-right">2019-06-07 12:10:41</a><p>New download section. <a href="downloads.php">Check out.</a></p></li></ul></div><div class="carousel-item "><ul class="timeline"><li><a href="#">Sponsorship Oportunities Updated</a><a href="#" class="float-right">2019-05-23 12:17:41</a><p>We made changes in our sponsors section. <a href="sponsors.php">Check out.</a></p></li><li><a href="#">Fees Information Updated</a><a href="#" class="float-right">2019-03-19 19:11:41</a><p>Check out our new fee charts. <a href="fees.php">Go.</a></p></li></div>
     </div>
   </div>
 </div>     
   </div>
...
<p class="text-muted">Take a time to visit our sponsors:</p>
<div class="row featurette" style="margin-top: 50px; margin-bottom: 50px;">
  <div class="col-sm-3 text-center">
    <a href="https://www.unisimon.edu.co/" target="_blank">
  ...
  <hr class="featurette-divider">
  <h2 class="featurette-heading" id="divdirections">Directions</h2>
  <p class="text-muted">Conference will take place in Universidad del Norte. The suggested hotel is the NH Collection:</p>
  <div class="row featurette">
    <div class="col-sm-12">
  ...
  <div class="col-sm-12 text-center">
  <h2 class="featurette-heading">
  <a href="http://iccl2019.co/downloads.php">Scan QR-Code to Download ICCL2019 Mobile App for Android </a>
  </h2>
  <div class="col-sm-12 text-center">
   <img src="img/qrapp.png" />
  </div>
  </div>
  </div></div>
<hr/>
